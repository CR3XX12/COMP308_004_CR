...
const UPDATE_TASK = gql`
  mutation UpdateTask($id: ID!, $taskId: String!, 
...
function EditTask(props) {
  ...
  const { loading, error, data } = useQuery(GET_TASK, {
    ...
    onCompleted: (data) => {
      ...
      setTask({ id, taskId: currentTaskId, taskName: currentTaskName,      
      taskDescription: currentTaskDescription, startDate: currentStartDate,
        endDate: currentEndDate, owner: currentOwner });
  ...
  const [task, setTask] = useState({ id: '', taskId: '', taskName: '', 
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group controlId="formEndDate">
          ...
          <Form.Control
            ...
            value={task.endDate || data.task.endDate}
            onChange={handleInputChange}
          />
        </Form.Group>
        <Form.Group controlId="formOwner">
          ...
          <Form.Control
            ...
            value={task.owner || data.task.owner}
            onChange={handleInputChange}
          />
        </Form.Group>
